# FFmpegKit iOS - "https" package (LGPL v3.0, no GPL libraries).
#
...
#
# Publish:  POD_VERSION=6.0.2 pod trunk push cocoapods/ffmpeg-mobile-https.podspec
...
Pod::Spec.new do |s|
  ...
  s.summary          = "FFmpegKit iOS xcframeworks (https package)"
  ...
  s.source = {
    :http => "https://github.com/maitrungduc1410/ffmpeg-kit/releases/download/ios-#{s.version}/ffmpeg-mobile-https.zip"
  }
