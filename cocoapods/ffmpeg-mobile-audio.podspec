# FFmpegKit iOS - "audio" package (LGPL v3.0, no GPL libraries).
#
...
#
# Publish:  POD_VERSION=6.0.2 pod trunk push cocoapods/ffmpeg-mobile-audio.podspec
# (POD_VERSION must match the GitHub Release tag, e.g. release "ios-6.0.2".)
Pod::Spec.new do |s|
  s.name             = "ffmpeg-mobile-audio"
  s.version          = ENV["POD_VERSION"] || "6.0.2"
  s.summary          = "FFmpegKit iOS xcframeworks (audio package)"
  ...
  s.source = {
    :http => "https://github.com/maitrungduc1410/ffmpeg-kit/releases/download/ios-#{s.version}/ffmpeg-mobile-audio.zip"
  }
