# FFmpegKit iOS - "min" package (LGPL v3.0, no GPL libraries).
#
...
#
# Publish:  POD_VERSION=6.0.2 pod trunk push cocoapods/ffmpeg-mobile-min.podspec
...
Pod::Spec.new do |s|
  ...
  s.summary          = "FFmpegKit iOS xcframeworks (min package)"
  ...
  s.source = {
    :http => "https://github.com/maitrungduc1410/ffmpeg-kit/releases/download/ios-#{s.version}/ffmpeg-mobile-min.zip"
  }
